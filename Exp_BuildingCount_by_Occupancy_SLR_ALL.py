...
QSLR1 = QSLR1_string
QSLR2_string = f"{SLR2} IS NOT NULL"
QSLR2 = QSLR2_string
QSLR3_string = f"{SLR3} IS NOT NULL"
QSLR3 = QSLR3_string
...
SLR1_FC = FL_fc(input_feature,QSLR1,default_gdb,'All_SLR1_Query')
exposure(SLR1_FC)
SLR2_FC = FL_fc(input_feature,QSLR2,default_gdb,'All_SLR2_Query')
exposure(SLR2_FC)
SLR3_FC = FL_fc(input_feature,QSLR3,default_gdb,'All_SLR3_Query')
exposure(SLR3_FC)