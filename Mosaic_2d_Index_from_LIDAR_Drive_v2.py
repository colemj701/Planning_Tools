...
LiDAR_Path = r'\\5rd2wx3\LIDAR_RASTERS\Statewide LiDAR DEMs'

#Logging level specified in script configuration
directory, filename, gp_dir = dir_file(Out_Raster)
log_setup(gp_dir)
Index_List = build_tile_index(Smp_tiles,tile_field,DLQ)
Raster_List, Unmatched_List = bld_tile_path(LiDAR_Path,Index_List,DLQ)
mosaic(Raster_List,Out_Raster,Raster_List)
