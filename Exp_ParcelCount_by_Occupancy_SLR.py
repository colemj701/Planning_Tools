...
QSLR1 = QSLR1_string
QSLR2_string = f"MAX_{SLR2} IS NOT NULL And MAX_{SLR1} IS NULL"
QSLR2 = QSLR2_string
QSLR3_string = f"MAX_{SLR3} IS NOT NULL And MAX_{SLR2} IS NULL And MAX_{SLR1} IS NULL"
QSLR3 = QSLR3_string
...
SLR1_FC = FL_fc(dis1,QSLR1,default_gdb,'Min_SLR1_Query')
exposure(SLR1_FC)
SLR2_FC = FL_fc(dis1,QSLR2,default_gdb,'Min_SLR2_Query')
exposure(SLR2_FC)
SLR3_FC = FL_fc(dis1,QSLR3,default_gdb,'Min_SLR3_Query')
exposure(SLR3_FC)