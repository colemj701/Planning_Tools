...
QSLOSH2_string = f"{SLOSH2} IS NOT NULL And {SLOSH1} IS NULL"
QSLOSH2 = QSLOSH2_string
QSLOSH3_string = f"{SLOSH3} IS NOT NULL And {SLOSH2} IS NULL And {SLOSH1} IS NULL"
QSLOSH3 = QSLOSH3_string
QSLOSH4_string = f"{SLOSH4} IS NOT NULL And {SLOSH3} IS NULL And {SLOSH2} IS NULL And {SLOSH1} IS NULL"
QSLOSH4 = QSLOSH4_string
QSLOSH5_string = f"{SLOSH5} IS NOT NULL And {SLOSH4} IS NULL And {SLOSH3} IS NULL And {SLOSH2} IS NULL And {SLOSH1} IS NULL"
...
SLOSH1_FC = FL_fc(input_feature,QSLOSH1,default_gdb,'Min_SLOSH1_Query')
exposure(SLOSH1_FC)
SLOSH2_FC = FL_fc(input_feature,QSLOSH2,default_gdb,'Min_SLOSH2_Query')
exposure(SLOSH2_FC)
SLOSH3_FC = FL_fc(input_feature,QSLOSH3,default_gdb,'Min_SLOSH3_Query')
exposure(SLOSH3_FC)
SLOSH4_FC = FL_fc(input_feature,QSLOSH4,default_gdb,'Min_SLOSH4_Query')
exposure(SLOSH4_FC)
SLOSH5_FC = FL_fc(input_feature,QSLOSH5,default_gdb,'Min_SLOSH5_Query')
exposure(SLOSH5_FC)