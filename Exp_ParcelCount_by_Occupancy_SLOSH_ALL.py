...
QSLOSH2_string = f"MAX_{SLOSH2} IS NOT NULL"
QSLOSH2 = QSLOSH2_string
QSLOSH3_string = f"MAX_{SLOSH3} IS NOT NULL"
QSLOSH3 = QSLOSH3_string
QSLOSH4_string = f"MAX_{SLOSH4} IS NOT NULL"
QSLOSH4 = QSLOSH4_string
QSLOSH5_string = f"MAX_{SLOSH5} IS NOT NULL"
...
SLOSH1_FC = FL_fc(dis1,QSLOSH1,default_gdb,'All_SLOSH1_Query')
exposure(SLOSH1_FC)
SLOSH2_FC = FL_fc(dis1,QSLOSH2,default_gdb,'All_SLOSH2_Query')
exposure(SLOSH2_FC)
SLOSH3_FC = FL_fc(dis1,QSLOSH3,default_gdb,'All_SLOSH3_Query')
exposure(SLOSH3_FC)
SLOSH4_FC = FL_fc(dis1,QSLOSH4,default_gdb,'All_SLOSH4_Query')
exposure(SLOSH4_FC)
SLOSH5_FC = FL_fc(dis1,QSLOSH5,default_gdb,'All_SLOSH5_Query')
exposure(SLOSH5_FC)